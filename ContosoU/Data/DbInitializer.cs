...
namespace ContosoU.Models
{
    ...
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            {
                new Instructor{FirstName="Fabien", LastName="Comeau", Email="devillettuce@gmail.com", HireDate=DateTime.Parse("2017-09-01")},
                new Instructor{FirstName="John", LastName="Smith", Email="devillettuce@gmail.com", HireDate=DateTime.Parse("2011-09-01")},
